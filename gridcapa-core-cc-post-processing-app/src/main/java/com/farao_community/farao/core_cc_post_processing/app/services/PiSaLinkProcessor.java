...
public class PiSaLinkProcessor {
    ...
    private final PiSaConfiguration.PiSaLinkConfiguration piSaLinkConfiguration;

    public PiSaLinkProcessor(PiSaConfiguration.PiSaLinkConfiguration piSaLinkConfiguration) {
...
//            piSaLinkConfiguration.piSaLinkFictiveNodeFr(),
//            piSaLinkConfiguration.piSaLinkFictiveNodeIt()
...
//            piSaLinkConfiguration.piSaLinkFictiveLines().stream()
...
//        return network.getBusBreakerView().getBus(piSaLinkConfiguration.piSaLinkFictiveNodeFr()).isInMainConnectedComponent()
//            && network.getBusBreakerView().getBus(piSaLinkConfiguration.piSaLinkFictiveNodeIt()).isInMainConnectedComponent();
//    }
//
...
//        List<Line> fictiveLines = piSaLinkConfiguration.piSaLinkFictiveLines().stream()
//            .map(network::getLine)
//            .toList();
...
//                          piSaLinkConfiguration.piSaLinkFictiveNodeFr(), piSaLinkConfiguration.piSaLinkFictiveNodeIt()));
//    }
//
//    public void setLinkInSetpointMode(Network network, Crac crac) {
//        List<Line> connectingLines = piSaLinkConfiguration.piSaLinkFictiveLines().stream()
//            .map(network::getLine)
//            .toList();
...
//    }
    ...
    public Set<InjectionRangeAction> getRelatedHvdcRangeActions(Crac crac) {
        Set<String> fictiveGeneratorIds = Stream.of(piSaLinkConfiguration.piSaLinkFictiveNodeFr(), piSaLinkConfiguration.piSaLinkFictiveNodeIt())
...
//        return getGenerator(network, piSaLinkConfiguration.piSaLinkFictiveNodeFr());
//    }

    public Generator getItFictiveGenerator(Network network) {
        return getGenerator(network, piSaLinkConfiguration.piSaLinkFictiveNodeIt());
    }
...
//        return piSaLinkConfiguration.piSaLinkPraName();
//    }
