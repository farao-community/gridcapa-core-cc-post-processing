 ...
 */
class CoreCCPostProcessingInternalExceptionTest {
    @Test
    void checkStandardExceptionUsage() {
        AbstractCoreCCPostProcessingException exception = new CoreCCPostProcessingInternalException("Exception message");
        ...
        exception = new CoreCCPostProcessingInternalException("Exception message", cause);
        assertEquals("Exception message", exception.getMessage());
